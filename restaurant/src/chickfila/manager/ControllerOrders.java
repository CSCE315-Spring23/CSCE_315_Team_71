...
public class ControllerOrders {
    ...
    * This method loads the orders data into the table view based on the beginning date and end date entered by the user.

    * It sets the cell value factory for the table columns to retrieve the relevant attributes from the Orders class objects.

    * It also calculates and displays the total profit, tax and sales amount of the orders within the given date range.

    * @param event The action event generated by the user clicking the "Load Orders" button
